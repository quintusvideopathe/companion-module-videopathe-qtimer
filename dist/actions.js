import { CHRONO_COLOR_CHOICES, CHRONO_THRESHOLD_CHOICES, DISPLAY_MODE_CHOICES, END_ACTION_CHOICES, MODE_CHOICES_SECONDS_PERCENT, PLAYLIST_AUTO_MODE_CHOICES, TOGGLE_CHOICES, } from './choices.js';
function toggleChoiceToPayload(choice) {
    switch (choice) {
        case 'on':
            return true;
        case 'off':
